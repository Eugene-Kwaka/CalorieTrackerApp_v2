...
//import com.eugene.services.CalorieTrackService;
//import com.eugene.services.Result;
...
//
//    @GetMapping("/{cId}")
//    public ResponseEntity<CalorieTrackDTO> getCalorieTrack(@PathVariable Long cId){
...
//    public List<CalorieTrackDTO> getCalorieTrackByUser(@PathVariable Long uId){
//        return calorieTrackService.getCaloriesByUser(uId);
//    }
//
//    @GetMapping("/users/{uId}/date")
//    public List<CalorieTrackDTO> getCaloriesByUserAndDate(@PathVariable Long uId,
...
//    public List<CalorieTrackDTO> getCaloriesByUserAndDateBetween(@PathVariable Long uId,
...
//
//    @PutMapping("/{cId}")
//    public ResponseEntity<CalorieTrackDTO> updateCalorieTrack(@PathVariable Long cId,
...
//
//    @DeleteMapping("/{cId}")
//    public ResponseEntity<Void> deleteCalorieTrackById(@PathVariable Long cId){
