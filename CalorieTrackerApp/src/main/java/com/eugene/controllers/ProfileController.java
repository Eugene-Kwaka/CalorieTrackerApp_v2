...
public class ProfileController {
    ...
    @PostMapping
    public ResponseEntity<ProfileDTO> createProfile(@PathVariable Long uId, @RequestBody ProfileDTO profileDTO){
    ...
    @GetMapping("/{pId}")
    public ResponseEntity<ProfileDTO> getProfile(@PathVariable Long pId){
    ...
    @PutMapping("/{pId}")
    public ResponseEntity<ProfileDTO> updateProfile(@PathVariable Long uId, @PathVariable Long pId, @RequestBody ProfileDTO profileDTO){
    ...
    @DeleteMapping("/{pId}")
    public ResponseEntity<Void> deleteProfile(@PathVariable Long uId, @PathVariable Long pId){
